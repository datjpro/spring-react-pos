...
public class SupplierServiceImpl implements SupplierService {
    ...
    private void apply(SupplierEntity e, SupplierRequest r) {
        e.setCode(r.code());
        e.setName(r.name());
        e.setPhone(r.phone());
        e.setEmail(r.email());
    ...
    private SupplierResponse map(SupplierEntity e) {
        return new SupplierResponse(e.getId(), e.getCode(), e.getName(), e.getPhone(), e.getEmail(), e.getAddress(),
                e.isActive());
    }
}
