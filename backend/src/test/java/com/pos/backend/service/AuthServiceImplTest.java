...
class AuthServiceImplTest {
    ...
    void setUp() {
        ...
        authService = new AuthServiceImpl(authenticationManager, userRepository, refreshTokenRepository, jwtService, securityProperties);
    }
    ...
    void shouldRefreshTokenSuccessfully() {
        ...
        String refreshToken = Jwts.builder()
                ...
                .signWith(Keys.hmacShaKeyFor(securityProperties.secret().getBytes(StandardCharsets.UTF_8)))
                .compact();
